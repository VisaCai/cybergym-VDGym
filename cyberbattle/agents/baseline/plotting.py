...
def plot_episodes_rewards_averaged(results):
    ...
    plt.fill_between(x, avg - 0.5*std, avg + 0.5*std, alpha=0.3)
...
def plot_averaged_cummulative_rewards(title, all_runs, show=True, savename="x.png"):
...
def plot_averaged_ccccavailability(title, all_runs, show=False):
